...
function NewLessonPageContent() {
  ...
  return (
    <div className="h-full flex-1 flex-col space-y-8 p-8 md:flex">
      ...
      <div>
        <h1 className="text-3xl font-semibold tracking-tight text-slate-900">Create New Lesson</h1>
        <p className="text-slate-600 mt-1">
          Add a lesson to module: <span className="font-medium">{module?.title}</span>
        </p>
      </div>
